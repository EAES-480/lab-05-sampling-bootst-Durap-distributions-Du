...
> The `se_theory`(0.8495689	) and `se_simulated` (0.8731462)  were very close. Increasing n_samp reduces the standard error. The variability in the sample mean decreases as sample size increases. Increasing reps, however, does not change the true SE; it only smooth our simulation estimate of the sampling distribution.
...
boot_means_summer <- replicate(
  B,
  mean(sample(swc_summer_pool, size = n_samp, replace = TRUE))
)
